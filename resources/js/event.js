document.addEventListener('DOMContentLoaded', function () {
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-white rounded-lg p-4 mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div><strong>Tanggal Event :</strong> 24 Januari - 24 Januari</div>
                            <div><strong>Batas Daftar & Bayar :</strong> 10 Desember - 20 Januari</div>
                        </div>
                    </div>
    ...
    // Pastikan fungsi bisa dipanggil dari onclick
